...
public class CustomerServiceDetailsPopUp implements KeyListener, ComponentListener {
    ...
    public static void main(String[] args){new CustomerServiceDetailsPopUp();}

    public CustomerServiceDetailsPopUp(){
        panel = new JPanel();
